...
<div class="container-fluid">
    <!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Registro de Nuevas Mascotas</h1>
<p class="mb-4">En esta pestaña podra ingresar un nueva Mascota</p>
    <!-- Basic Card Example -->
        ...
        <span class="text">Volver</span>
            ...
            <?php
				...
				if(isset($_POST) && !empty($_POST)){
					$usuario = $mascotas->sanitize($_POST['usuario']);
			...
			?>
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control" id="usuario" name="usuario" >
                      <?php
                      $usarUsuarios = $mascotas->usarUsuarios();
                while ($row=mysqli_fetch_object($usarUsuarios)){
                    $id_usar_usuario=$row->id;
                    $nombre_usar_usuario=$row->nombre;
                    $apellido_usar_usuario=$row->apellido;
                    $rut_usar_usuario=$row->rut;
             ?>

          <option value=<?php echo $id_usar_usuario ?>><?php echo $rut_usar_usuario. " # ". $nombre_usar_usuario. "  ". $apellido_usar_usuario  ?></option>
